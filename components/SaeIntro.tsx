...
import styles from '../styles/SaeIntro.module.css'; // Import your CSS module
...
const SaeIntro: React.FC<SaeIntroProps> = ({ saeNameText, saeLongText }) => {
  return (
    <div className={styles.sae_intro}>
      <div className={styles.right_wrapper_saeintro}>
        <div className={styles.sae_headings}>
          <h1 className={styles.sae_name_text}>{saeNameText}</h1>
        </div>
        <div className={styles.sae_content}>
          <p className={styles.sae_long_text}>{saeLongText}</p>
        </div>
